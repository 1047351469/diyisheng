<template>
  ...
  import { toRefs,ref, onBeforeMount, onMounted, onBeforeUpdate, onUpdated, onBeforeUnmount, onUnmounted, onErrorCaptured, onActivated, onDeactivated } from 'vue';
...
setInterval(() => {
  ...
  person.value.name.hobby.push(2)
}, 3000);
